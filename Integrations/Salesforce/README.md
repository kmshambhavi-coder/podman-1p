...
##### JSON Results
```json
[{"Field2": "Value2", "attributes": {"url": "/services/data/v20.0/sobjects/Case/123456789", "type": "Case"}, "Field1": "Value1", "Field3": "Value3"}, {"Field2": "Value2", "attributes": {"url": "/services/data/v20.0/sobjects/Case/123456789", "type": "Case"}, "Field1": "Value1", "Field3": "Value3"}]
```
...
|Status|The case's status. Valid values: New, On Hold, Closed, Escalated|False|String||
...
|Priority|The case's priority. Valid values: Low, Medium, High|False|String||
